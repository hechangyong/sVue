  ...
  <div id="page" class="page" ref='page'>
    <div class="view">
      <div class='banner'>
        ...
        <div class="inquire-link flex-between auto">
          <div class='link-item' @click="toProduct('query')">
            <img src="../../../assets/image/query_icon.png" alt="">
            <p>购物清单</p>
          </div>
          <div class='link-item' @click="mockUser('cardList')">
      ...
      <div class="content">
        <item label="我的地址" type='address' placeholder="常住地址" :value='userDetail&&addressDetail'
              @click.native="jumpTo('changeinfo','address')"></item>
      </div>
    </div>
  </div>
</template>
